...
from gscan_metaseq2seq.models.enc_dec_transformer.enc_dec_universal_transformer_model import (
    TransformerLearner,
)
...
def main():
    ...
    exp_name = "gscan"
    model_name = f"universal_transformer_encoder_only_decode_actions_l_{args.nlayers}_h_{args.nhead}_d_{args.hidden_size}"
