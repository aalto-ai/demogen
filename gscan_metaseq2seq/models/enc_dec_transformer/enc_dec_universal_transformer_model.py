...
class RecurrentEncoder(nn.Module):
    ...
    def forward(self, src, src_key_padding_mask=None):
        for i in range(self.num_layers):
            src = self.module(src, src_key_padding_mask=src_key_padding_mask)
...
class RecurrentDecoder(nn.Module):
    ...
    def forward(self, tgt, memory, tgt_key_padding_mask=None, memory_key_padding_mask=None,  tgt_mask=None):
        for i in range(self.num_layers):
            tgt = self.module(tgt, memory, tgt_key_padding_mask=tgt_key_padding_mask, memory_key_padding_mask=memory_key_padding_mask, tgt_mask=tgt_mask)
...
class StateEncoderTransformer(nn.Module):
    def __init__(
        ...
        self.transformer_encoder = RecurrentEncoder(
